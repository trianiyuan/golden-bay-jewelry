...
const styles = StyleSheet.create({
  ...
  confirmBox: { backgroundColor: '#FFF1ED', borderRadius: 20, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.15, shadowRadius: 24, maxWidth: 480, width: '100%', alignSelf: 'center' },  confirmTitulo: { fontSize: 16, fontWeight: '700', color: COLORS.textPrimary, marginBottom: 8 },
